	...
	<body>
		...
		<article>
			...
			<section class="gifts">
				...
				<div>
					<img src="img/LivingWater.jpg" />
					<h4>Living Water - Gospel of John</h4>
					<p>An attractive, pocket-sized copy of the fourth book in the New Testament. Written in a contemporary but accurate way, Living Water is the full text of the Gospel by John. Yours just for the asking.</p>
